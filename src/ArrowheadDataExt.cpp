...
namespace arrowhead{
	...
	// reads json file
	void ArrowheadDataExt::load(std::string file_path){
	...
	// load the params that have been set
	// tested group wise
	...
	void ArrowheadDataExt::setService(json_object *service) {
		SERVICE_NAME = getString("service_name", service);
	...
	//////////////////////////////////////
	// reads and return specific entity //
	//////////////////////////////////////
